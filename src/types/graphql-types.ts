...
/** Input for the createCustomForm mutation. */
...
/** The payload for the createCustomForm mutation. */
export type CreateCustomFormPayload = {
  __typename?: 'CreateCustomFormPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
...
/** The CustomForm type */
export type CustomForm = ContentNode & DatabaseIdentifier & Node & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfFormFields & {
  __typename?: 'CustomForm';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors: Maybe<CustomFormToCustomFormConnection>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
   ...
   */
  customFormId: Scalars['Int']['output'];
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  /** Post publishing date. */
  date: Maybe<Scalars['String']['output']>;
  ...
  /** Connection between the ContentNode type and the EnqueuedStylesheet type */
  enqueuedStylesheets: Maybe<ContentNodeToEnqueuedStylesheetConnection>;
  /** Fields of the FormFields ACF Field Group */
  formFields: Maybe<FormFields>;
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid: Maybe<Scalars['String']['output']>;
  /** Whether the custom_form object is password protected. */
  hasPassword: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the custom_form object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   */
  parent: Maybe<CustomFormToParentConnectionEdge>;
  /** The password for the custom_form object. */
  password: Maybe<Scalars['String']['output']>;
  /** Connection between the CustomForm type and the CustomForm type */
  preview: Maybe<CustomFormToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId: Maybe<Scalars['ID']['output']>;
...
/** The CustomForm type */
export type CustomFormAncestorsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The CustomForm type */
export type CustomFormEnqueuedScriptsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The CustomForm type */
export type CustomFormEnqueuedStylesheetsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The CustomForm type */
export type CustomFormTitleArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};

/** A paginated collection of CustomForm Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of CustomForm Nodes */
export type CustomFormConnection = {
  /** A list of edges (relational context) between RootQuery and connected CustomForm Nodes */
  edges: Array<CustomFormConnectionEdge>;
  /** A list of connected CustomForm Nodes */
  nodes: Array<CustomForm>;
  /** Information about pagination in a connection. */
  pageInfo: CustomFormConnectionPageInfo;
};

/** Represents a connection to a CustomForm. Contains both the CustomForm Node and metadata about the relationship. */
export type CustomFormConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The connected CustomForm Node */
  node: CustomForm;
};

/** Pagination metadata specific to &quot;CustomFormConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;CustomFormConnectionEdge&quot; Nodes. */
export type CustomFormConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Identifier types for retrieving a specific CustomForm. Specifies which unique attribute is used to find an exact CustomForm. */
export enum CustomFormIdType {
  /** Identify a resource by the Database ID. */
  DATABASE_ID = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  ID = 'ID',
...
/** Connection between the CustomForm type and the CustomForm type */
export type CustomFormToCustomFormConnection = Connection & CustomFormConnection & {
  __typename?: 'CustomFormToCustomFormConnection';
  /** Edges for the CustomFormToCustomFormConnection connection */
  edges: Array<CustomFormToCustomFormConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<CustomForm>;
  /** Information about pagination in a connection. */
  pageInfo: CustomFormToCustomFormConnectionPageInfo;
};

/** An edge in a connection */
export type CustomFormToCustomFormConnectionEdge = CustomFormConnectionEdge & Edge & {
  __typename?: 'CustomFormToCustomFormConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;CustomFormToCustomFormConnection&quot; collections. Provides cursors and flags for navigating through sets of CustomFormToCustomFormConnection Nodes. */
export type CustomFormToCustomFormConnectionPageInfo = CustomFormConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'CustomFormToCustomFormConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the CustomForm type and the CustomForm type */
export type CustomFormToParentConnectionEdge = CustomFormConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'CustomFormToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the CustomForm type and the CustomForm type */
export type CustomFormToPreviewConnectionEdge = CustomFormConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'CustomFormToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: CustomForm;
...
/** Input for the deleteCustomForm mutation. */
export type DeleteCustomFormInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the CustomForm to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteCustomForm mutation. */
export type DeleteCustomFormPayload = {
  __typename?: 'DeleteCustomFormPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
...
export type Footer = AcfFieldGroup & AcfFieldGroupFields & FooterFields & {
  __typename?: 'Footer';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
  ...
  footerPages: Maybe<Array<Maybe<FooterFooterPages>>>;
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;Footer&quot; Field Group */
  footerServices: Maybe<Array<Maybe<FooterFooterServices>>>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;Footer&quot; Field Group */
  telephone: Maybe<Scalars['String']['output']>;
};

/** The &quot;FooterFooterPages&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type FooterFooterPages = AcfFieldGroup & AcfFieldGroupFields & FooterFooterPagesFields & {
  __typename?: 'FooterFooterPages';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;FooterFooterPages&quot; Field Group */
  menuItem: Maybe<AcfLink>;
};

/** Interface representing fields of the ACF &quot;FooterFooterPages&quot; Field Group */
export type FooterFooterPagesFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The &quot;FooterFooterServices&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type FooterFooterServices = AcfFieldGroup & AcfFieldGroupFields & FooterFooterServicesFields & {
  __typename?: 'FooterFooterServices';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;FooterFooterServices&quot; Field Group */
  menuItem: Maybe<AcfLink>;
};

/** Interface representing fields of the ACF &quot;FooterFooterServices&quot; Field Group */
export type FooterFooterServicesFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The &quot;FormFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type FormFields = AcfFieldGroup & AcfFieldGroupFields & FormFieldsFields & {
   ...
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;FormFields&quot; Field Group */
  formFields: Maybe<Array<Maybe<FormFieldsFormFields>>>;
};

/** The &quot;FormFieldsFormFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type FormFieldsFormFields = AcfFieldGroup & AcfFieldGroupFields & FormFieldsFormFieldsFields & {
  __typename?: 'FormFieldsFormFields';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;FormFieldsFormFields&quot; Field Group */
  formFieldLabel: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;FormFieldsFormFields&quot; Field Group */
  formFieldName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;FormFieldsFormFields&quot; Field Group */
  formFieldType: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;FormFieldsFormFields&quot; Field Group */
  formFieldsDefault: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;FormFieldsFormFields&quot; Field Group */
  formFieldsOptions: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;FormFieldsFormFields&quot; Field Group */
  formFieldsPlaceholder: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;true_false&quot; Field Type added to the schema as part of the &quot;FormFieldsFormFields&quot; Field Group */
  formFieldsRequired: Maybe<Scalars['Boolean']['output']>;
};

/** Interface representing fields of the ACF &quot;FormFieldsFormFields&quot; Field Group */
export type FormFieldsFormFieldsFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;FormFields&quot; Field Group */
export type FormFieldsFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
export type HeaderMenu = AcfFieldGroup & AcfFieldGroupFields & HeaderMenuFields & {
  ...
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;HeaderMenu&quot; Field Group */
  actionMenu: Maybe<Array<Maybe<HeaderMenuActionMenu>>>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;HeaderMenu&quot; Field Group */
  mainMenu: Maybe<Array<Maybe<HeaderMenuMainMenu>>>;
};

/** The &quot;HeaderMenuActionMenu&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type HeaderMenuActionMenu = AcfFieldGroup & AcfFieldGroupFields & HeaderMenuActionMenuFields & {
  __typename?: 'HeaderMenuActionMenu';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;HeaderMenuActionMenu&quot; Field Group */
  menuItem: Maybe<AcfLink>;
};

/** Interface representing fields of the ACF &quot;HeaderMenuActionMenu&quot; Field Group */
export type HeaderMenuActionMenuFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The &quot;HeaderMenuMainMenu&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type HeaderMenuMainMenu = AcfFieldGroup & AcfFieldGroupFields & HeaderMenuMainMenuFields & {
  __typename?: 'HeaderMenuMainMenu';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;HeaderMenuMainMenu&quot; Field Group */
  menuItem: Maybe<AcfLink>;
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;HeaderMenuMainMenu&quot; Field Group */
  submenu: Maybe<Array<Maybe<HeaderMenuMainMenuSubmenu>>>;
};

/** The &quot;HeaderMenuMainMenuSubmenu&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type HeaderMenuMainMenuSubmenu = AcfFieldGroup & AcfFieldGroupFields & HeaderMenuMainMenuSubmenuFields & {
  __typename?: 'HeaderMenuMainMenuSubmenu';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;HeaderMenuMainMenuSubmenu&quot; Field Group */
  link: Maybe<AcfLink>;
};

/** Interface representing fields of the ACF &quot;HeaderMenuMainMenuSubmenu&quot; Field Group */
export type HeaderMenuMainMenuSubmenuFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;HeaderMenuMainMenu&quot; Field Group */
export type HeaderMenuMainMenuFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;HeaderMenu&quot; Field Group */
...
export type PageBuilder = AcfFieldGroup & AcfFieldGroupFields & PageBuilderFields & {
...
/** The &quot;PageBuilderContentCalloutBlockLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentCalloutBlockLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentCalloutBlockLayoutFields & PageBuilderContentLayout & {
  __typename?: 'PageBuilderContentCalloutBlockLayout';
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCalloutBlockLayout&quot; Field Group */
  calloutItem: Maybe<Array<Maybe<PageBuilderContentCalloutItem>>>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageBuilderContentCalloutBlockLayout&quot; Field Group */
export type PageBuilderContentCalloutBlockLayoutFields = {
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCalloutBlockLayout&quot; Field Group */
  calloutItem: Maybe<Array<Maybe<PageBuilderContentCalloutItem>>>;
  /**
   * The name of the field group
...
/** The &quot;PageBuilderContentCalloutItem&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentCalloutItem = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentCalloutItemFields & {
  __typename?: 'PageBuilderContentCalloutItem';
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCalloutItem&quot; Field Group */
  calloutDescription: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCalloutItem&quot; Field Group */
  calloutHeadline: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCalloutItem&quot; Field Group */
  calloutIcon: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageBuilderContentCalloutItem&quot; Field Group */
export type PageBuilderContentCalloutItemFields = {
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCalloutItem&quot; Field Group */
  calloutDescription: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCalloutItem&quot; Field Group */
  calloutHeadline: Maybe<Scalars['String']['output']>;
...
/** The &quot;PageBuilderContentCardDeckItem&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentCardDeckItem = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentCardDeckItemFields & {
  __typename?: 'PageBuilderContentCardDeckItem';
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCardDeckItem&quot; Field Group */
  cardDeckDescription: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCardDeckItem&quot; Field Group */
  cardDeckHeadline: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCardDeckItem&quot; Field Group */
  cardDeckIcon: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageBuilderContentCardDeckItem&quot; Field Group */
export type PageBuilderContentCardDeckItemFields = {
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCardDeckItem&quot; Field Group */
  cardDeckDescription: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCardDeckItem&quot; Field Group */
  cardDeckHeadline: Maybe<Scalars['String']['output']>;
...
/** The &quot;PageBuilderContentCardDeckLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentCardDeckLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentCardDeckLayoutFields & PageBuilderContentLayout & {
  __typename?: 'PageBuilderContentCardDeckLayout';
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCardDeckLayout&quot; Field Group */
  cardDeckItem: Maybe<Array<Maybe<PageBuilderContentCardDeckItem>>>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageBuilderContentCardDeckLayout&quot; Field Group */
export type PageBuilderContentCardDeckLayoutFields = {
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentCardDeckLayout&quot; Field Group */
  cardDeckItem: Maybe<Array<Maybe<PageBuilderContentCardDeckItem>>>;
  /**
   * The name of the field group
...
export type PageBuilderContentColumnContent = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentColumnContentFields & {
  ...
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContent&quot; Field Group */
...
export type PageBuilderContentColumnContentColumnButton = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentColumnContentColumnButtonFields & {
  __typename?: 'PageBuilderContentColumnContentColumnButton';
  /** Field of the &quot;true_false&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContentColumnButton&quot; Field Group */
  addButton: Maybe<Scalars['Boolean']['output']>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContentColumnButton&quot; Field Group */
  buttonIcon: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContentColumnButton&quot; Field Group */
...
/** Interface representing fields of the ACF &quot;PageBuilderContentColumnContentColumnButton&quot; Field Group */
export type PageBuilderContentColumnContentColumnButtonFields = {
  /** Field of the &quot;true_false&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContentColumnButton&quot; Field Group */
  addButton: Maybe<Scalars['Boolean']['output']>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContentColumnButton&quot; Field Group */
  buttonIcon: Maybe<Array<Maybe<Scalars['String']['output']>>>;
...
export type PageBuilderContentColumnContentFields = {
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContent&quot; Field Group */
  columnButton: Maybe<PageBuilderContentColumnContentColumnButton>;
  /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;PageBuilderContentColumnContent&quot; Field Group */
  columnContent: Maybe<Scalars['String']['output']>;
...
export type PageBuilderContentContactFormLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentContactFormLayoutFields & PageBuilderContentLayout & {
  __typename?: 'PageBuilderContentContactFormLayout';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  ...
  linkedForm: Maybe<AcfContentNodeConnectionEdge>;
};

/** Interface representing fields of the ACF &quot;PageBuilderContentContactFormLayout&quot; Field Group */
export type PageBuilderContentContactFormLayoutFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The &quot;PageBuilderContentFeatureColumnsColumns&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentFeatureColumnsColumns = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentFeatureColumnsColumnsFields & {
  __typename?: 'PageBuilderContentFeatureColumnsColumns';
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentFeatureColumnsColumns&quot; Field Group */
...
/** The &quot;PageBuilderContentFeatureColumnsColumnsColumnImages&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentFeatureColumnsColumnsColumnImages = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentFeatureColumnsColumnsColumnImagesFields & {
  __typename?: 'PageBuilderContentFeatureColumnsColumnsColumnImages';
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;PageBuilderContentFeatureColumnsColumnsColumnImages&quot; Field Group */
  columnImagesStack: Maybe<AcfMediaItemConnectionEdge>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageBuilderContentFeatureColumnsColumnsColumnImages&quot; Field Group */
export type PageBuilderContentFeatureColumnsColumnsColumnImagesFields = {
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;PageBuilderContentFeatureColumnsColumnsColumnImages&quot; Field Group */
  columnImagesStack: Maybe<AcfMediaItemConnectionEdge>;
  /**
   * The name of the field group
...
/** Interface representing fields of the ACF &quot;PageBuilderContentFeatureColumnsColumns&quot; Field Group */
export type PageBuilderContentFeatureColumnsColumnsFields = {
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentFeatureColumnsColumns&quot; Field Group */
  columnImages: Maybe<Array<Maybe<PageBuilderContentFeatureColumnsColumnsColumnImages>>>;
  /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;PageBuilderContentFeatureColumnsColumns&quot; Field Group */
  columnText: Maybe<Scalars['String']['output']>;
...
/** The &quot;PageBuilderContentFeatureColumnsLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentFeatureColumnsLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentFeatureColumnsLayoutFields & PageBuilderContentLayout & {
  __typename?: 'PageBuilderContentFeatureColumnsLayout';
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentFeatureColumnsLayout&quot; Field Group */
  featureColumnsColumns: Maybe<Array<Maybe<PageBuilderContentFeatureColumnsColumns>>>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageBuilderContentFeatureColumnsLayout&quot; Field Group */
export type PageBuilderContentFeatureColumnsLayoutFields = {
  /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;PageBuilderContentFeatureColumnsLayout&quot; Field Group */
  featureColumnsColumns: Maybe<Array<Maybe<PageBuilderContentFeatureColumnsColumns>>>;
  /**
   * The name of the field group
...
/** The &quot;PageBuilderContentHeadlineLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentHeadlineLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentHeadlineLayoutFields & PageBuilderContentLayout & {
  __typename?: 'PageBuilderContentHeadlineLayout';
...
export type PageBuilderContentHeadlineLayoutFields = {
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeadlineLayout&quot; Field Group */
  containerWidth: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /**
   * The name of the field group
...
export type PageBuilderContentHeroLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentHeroLayoutFields & PageBuilderContentLayout & {
  __typename?: 'PageBuilderContentHeroLayout';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroImage: Maybe<AcfMediaItemConnectionEdge>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroPrimaryCta: Maybe<AcfLink>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroPrimaryCtaIcon: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Field of the &quot;link&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroSecondaryCta: Maybe<AcfLink>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroSecondaryCtaIcon: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroSubtitle: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroTitle: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PageBuilderContentHeroLayout&quot; Field Group */
  heroType: Maybe<Array<Maybe<Scalars['String']['output']>>>;
};

/** Interface representing fields of the ACF &quot;PageBuilderContentHeroLayout&quot; Field Group */
export type PageBuilderContentHeroLayoutFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The &quot;PageBuilderContentImageStack&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentImageStack = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentImageStackFields & {
  __typename?: 'PageBuilderContentImageStack';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;PageBuilderContentImageStack&quot; Field Group */
  stackImage: Maybe<AcfMediaItemConnectionEdge>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageBuilderContentImageStack&quot; Field Group */
  stackLabel: Maybe<Scalars['String']['output']>;
};

/** The &quot;PageBuilderContentImageStackLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentImageStackLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentImageStackLayoutFields & PageBuilderContentLayout & {
...
export type PageBuilderContentImageStackLayoutFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
export type PageBuilderContentImageStackFields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The &quot;PageBuilderContentTextLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageBuilderContentTextLayout = AcfFieldGroup & AcfFieldGroupFields & PageBuilderContentTextLayoutFields & PageBuilderContentLayout & {
  __typename?: 'PageBuilderContentTextLayout';
...
/** Interface representing fields of the ACF &quot;PageBuilderContentTextLayout&quot; Field Group */
...
/** Layout of the &quot;content&quot; Field of the &quot;PageBuilder&quot; Field Group Field */
export type PageBuilderContentLayout = {
  /** The name of the ACF Flex Field Layout */
  fieldGroupName: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;PageBuilder&quot; Field Group */
export type PageBuilderFields = {
  /** Field of the &quot;flexible_content&quot; Field Type added to the schema as part of the &quot;PageBuilder&quot; Field Group */
  content: Maybe<Array<Maybe<PageBuilderContentLayout>>>;
  /**
   * The name of the field group
...
export type RootMutation = {
  ...
  /** The createCustomForm mutation */
  createCustomForm: Maybe<CreateCustomFormPayload>;
  ...
  /** The deleteCustomForm mutation */
  deleteCustomForm: Maybe<DeleteCustomFormPayload>;
  ...
  /** The updateCustomForm mutation */
  updateCustomForm: Maybe<UpdateCustomFormPayload>;
...
/** The root mutation */
export type RootMutationCreateCustomFormArgs = {
...
/** The root mutation */
export type RootMutationDeleteCustomFormArgs = {
  input: DeleteCustomFormInput;
};
...
/** The root mutation */
export type RootMutationUpdateCustomFormArgs = {
...
export type RootQuery = WithAcfOptionsPageSiteOptions & {
  ...
  /** An object of the CustomForm Type.  */
  customForm: Maybe<CustomForm>;
  /**
   * A CustomForm object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  customFormBy: Maybe<CustomForm>;
  /** Connection between the RootQuery type and the CustomForm type */
  customForms: Maybe<RootQueryToCustomFormConnection>;
...
/** The root entry point into the Graph */
export type RootQueryCustomFormArgs = {
  asPreview: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType: InputMaybe<CustomFormIdType>;
};


/** The root entry point into the Graph */
export type RootQueryCustomFormByArgs = {
  customFormId: InputMaybe<Scalars['Int']['input']>;
  id: InputMaybe<Scalars['ID']['input']>;
  slug: InputMaybe<Scalars['String']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryCustomFormsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<RootQueryToCustomFormConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the CustomForm type */
export type RootQueryToCustomFormConnection = Connection & CustomFormConnection & {
  __typename?: 'RootQueryToCustomFormConnection';
  /** Edges for the RootQueryToCustomFormConnection connection */
  edges: Array<RootQueryToCustomFormConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<CustomForm>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToCustomFormConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToCustomFormConnectionEdge = CustomFormConnectionEdge & Edge & {
  __typename?: 'RootQueryToCustomFormConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: CustomForm;
...
/** Pagination metadata specific to &quot;RootQueryToCustomFormConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToCustomFormConnection Nodes. */
export type RootQueryToCustomFormConnectionPageInfo = CustomFormConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToCustomFormConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToCustomFormConnection connection */
export type RootQueryToCustomFormConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword: InputMaybe<Scalars['Boolean']['input']>;
...
export type SiteOptions = AcfOptionsPage & Node & WithAcfFooter & WithAcfHeaderMenu & {
  __typename?: 'SiteOptions';
  /** Fields of the Footer ACF Field Group */
  footer: Maybe<Footer>;
  /** Fields of the HeaderMenu ACF Field Group */
...
/** Input for the updateCustomForm mutation. */
export type UpdateCustomFormInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date: InputMaybe<Scalars['String']['input']>;
  /** The ID of the CustomForm object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateCustomForm mutation. */
export type UpdateCustomFormPayload = {
  __typename?: 'UpdateCustomFormPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  customForm: Maybe<CustomForm>;
...
/** Provides access to fields of the &quot;FormFields&quot; ACF Field Group via the &quot;formFields&quot; field */
export type WithAcfFormFields = {
  /** Fields of the FormFields ACF Field Group */
  formFields: Maybe<FormFields>;
};

/** Provides access to fields of the &quot;HeaderMenu&quot; ACF Field Group via the &quot;headerMenu&quot; field */
export type WithAcfHeaderMenu = {
  /** Fields of the HeaderMenu ACF Field Group */
  headerMenu: Maybe<HeaderMenu>;
};
